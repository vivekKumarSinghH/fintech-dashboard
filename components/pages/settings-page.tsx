...
export function SettingsPage({ animationsEnabled = true }: { animationsEnabled?: boolean }) {
  ...
  const notificationSettings: NotificationSetting[] = [
    ...
    { id: "push-notifications", name: "Push Notifications", description: "Receive push notifications", enabled: true },
    {
      id: "marketing-emails",
