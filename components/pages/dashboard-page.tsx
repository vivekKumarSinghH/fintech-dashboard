...
export function DashboardPage({ animationsEnabled = true }: { animationsEnabled?: boolean }) {
  // KPI data
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <Card className="md:col-span-1 overflow-hidden border-border bg-card">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            ...
            <Select options={["Last 7 days", "Last 30 days", "Last 90 days"]} defaultValue="Last 7 days" />
          </CardHeader>
          <CardContent>
